...
<body>
    ...
    <div class="container my-3">
        ...
        <?php 
            $noResult = true;
            $query = $_GET["search"];
            $sql = "SELECT * FROM `merch_categories` WHERE MATCH(categorieName, categorieDesc) against('$query')";
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            $query = $_GET["search"];
            $sql = "SELECT * FROM `merch_product` WHERE MATCH(productName, productDesc) against('$query')"; 
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">';
                                if($loggedin){
                                    $quaSql = "SELECT `itemQuantity` FROM `merch_viewcart` WHERE productId = '$pizzaId' AND `userId`='$userId'";
