...
<div class="header-top" data-header>
  <div class="container">
    ...
    <div class="header-actions">
      ...
      <?php
      $countsql = "SELECT SUM(`itemQuantity`) FROM `merch_viewcart` WHERE `userId`=$userId";
    ...
    <nav class="navbar">
      <ul class="navbar-list">
        ...
        <li>
          <a href="http://localhost/FYP_ERP/Modules/Merch/index.php#home" class="navbar-link has-after">Home</a>
        </li>

      

        <?php
        $sql = "SELECT categorieName, categorieId FROM `merch_categories`";
