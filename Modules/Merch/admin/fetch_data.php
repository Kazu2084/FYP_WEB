...
$sqlPie = "select COUNT(productId) as total, categorieName from merch_categories , merch_product where merch_categories.categorieId = merch_product.productCategorieId GROUP BY categorieName";
...
$sqlBar = "select userId, SUM(amount) as total FROM merch_orders GROUP BY userId";
