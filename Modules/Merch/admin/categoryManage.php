                        ...
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<div class="products-row">
                                        ...
                                        height: 100px;" src="../img/cardd-'.$catId. '.jpg" alt="image for this Category" width="150px" height="150px"></span></div>
...
<?php 
    $catsql = "SELECT * FROM `merch_categories`";
        ...
        <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
          ...
          <br>
				...
				<div class="form-group col-md-4">
					<img src="/Merch/img/cardd-<?php echo $catId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="Category image" width="100" height="100">
				</div>
			</div>
		</form>
        <form action="partials/_categoryManage.php" method="post">
