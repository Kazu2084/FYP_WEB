                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<div class="products-row">
                                            ...
                                            <div class="product-cell image"><span>
                                                ...
                                                height: 100px;" src="../img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </span></div>
...
<?php 
    $pizzasql = "SELECT * FROM `merch_product`";
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/Merch/img/pizzaa-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
