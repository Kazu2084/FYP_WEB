<?php 
    $itemModalSql = "SELECT * FROM `merch_orders`";
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    $mysql = "SELECT * FROM merch_orderitems WHERE orderId = $orderid";
                                    $myresult = mysqli_query($conn, $mysql);
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        $pizzaId = $myrow['productId'];
                                        $itemQuantity = $myrow['itemQuantity'];
                                        
                                        $itemsql = "SELECT * FROM `merch_product` WHERE productId = $pizzaId";
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="../Merch/img/pizzaa-'.$pizzaId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
