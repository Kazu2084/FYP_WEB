...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['removeItem'])) {
        ...
        $sql = "DELETE FROM `merch_product` WHERE `productId`='$pizzaId'";   
        $result = mysqli_query($conn, $sql);
        $filename = $_SERVER['DOCUMENT_ROOT']."/Merch/img/pizzaa-".$pizzaId.".jpg";
        if ($result){
    ...
    if(isset($_POST['updateItem'])) {
        ...
        $sql = "UPDATE merch_product SET productName='$pizzaName', productPrice='$pizzaPrice', productDesc='$pizzaDesc', productCategorieId='$pizzaCategorieId' WHERE productId='$pizzaId' ";   
        $result = mysqli_query($conn, $sql);
        if ($result){
