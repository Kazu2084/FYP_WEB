      ...
      <div class="modal-body">
        <form action="partials/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
            <div class="text-left my-2">    
                ...
                <div class="row mx-2">
                <input class="form-control col-md-3" id="status" name="status" value="<?php echo $orderStatus; ?>" type="number" min="0" max="3" required>   
                <br> 
                ...
                0=Order Placed.<br> 1=Preparing your Order.<br> 2=Order is ready.<br> 3=Order Cancelled.
                </div>
            </div>
