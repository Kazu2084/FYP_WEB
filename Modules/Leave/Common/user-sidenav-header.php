  ...
  <div style="width: 100%;overflow:auto;">
    <div class="app-container" style="float:left; position:sticky; top:0; z-index:1">
      <div class="app-header">
        ...
        <?php include '../includes/logged.php' ?>
        ...
        <aside class="border-right shadow-sm background text" id="aside-nav">
          <div id="side-nav">
            ...
            <ul class="nav flex-column" id="aside-nav-ul">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../employees/leave.php">
                  <i class="far fa-comment-alt" style="font-size: 19px;"></i>
                  <span style="font-size: 18px;" class="ms-2">Apply Leave</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../employees/leave-history.php" class="ms-2" style="font-size: 18px;">
                  <i class="far fa-comment-alt" style="font-size: 19px;"></i>
                  <span style="font-size: 18px;" class="ms-2">Leave History</span>
                </a>
              </li>
