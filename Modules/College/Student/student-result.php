...
<div class="app-content">
	...
	<div class="products-header">
								...
								$count=0;
									...
									while ($row=mysqli_fetch_array($run)) { ?>
										<div class="products-row">
											<div class="product-cell"><span><?php echo $row['course_code']."-".$row['semester'] ?></span></div>
											...
											<div class="product-cell"><span><?php echo $row['credit_hours'] ?></span></div>
											<div class="product-cell"><span><?php echo $row['total_marks'] ?></span></div>
											<div class="product-cell"><span><?php echo $row['obtain_marks'] ?></span></div>
											<?php  
											...
											?>
											<div class="product-cell"><span><?php echo $grade ?></span></div>
											<div class="product-cell"><span><?php echo $credits ?></span></div>
										</div>
									<?php
										$count++; 
								...
								?>
								<div class="products-row">
									<div class="product-cell"><span><?php echo"1." ?></span></div>
									<div class="product-cell"><span><?php echo"FINAL RESULT " ?></span></div>
									<div class="product-cell"><span><?php echo $count; ?></span></div>
									<div class="product-cell"><span><?php echo $cgpa ?></span></div>
									<div class="product-cell"><span><?php echo $total_marks; ?></span></div>
									<div class="product-cell"><span><?php echo $obtain_marks; ?></span></div>
									<?php  
									...
									?>
									<div class="product-cell"><span><?php echo $final ?></span></div>
									<div class="product-cell"><span><?php echo $gpa > 0 ? round($total_cgpa=$gpa/$cgpa,2) : "0" ?></span></div>
