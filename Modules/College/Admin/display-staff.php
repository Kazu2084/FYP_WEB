...
<?php  
	...
	if ($_SESSION["LoginAdmin"] && !$_SESSION['LoginStaff'])
	{
		...
		$staff_email=$_SESSION['LoginStaff'];
		$staff_id="";
	}
	else{ 
...
<html lang="en">
	...
	<?php
		if($staff_id){
			$query="select * from staff_info where staff_id='$staff_id'";
		}
		else{
			$query="select * from staff_info where email='$staff_email'";
		}
?>
		<div class="app-content">
	<div class="app-content-header">
		<h1 class="app-content-headerText">Staff Profile</h1>
	...
	?>
		<div class="container  mt-1  mb-1">
				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>Staff ID:</h5> <?php echo $row['staff_id']  ?><br><br>
						</div>		
					</div>
				</div>
				<hr>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>Status:</h5> <?php echo $row['staff_status']  ?></div>
