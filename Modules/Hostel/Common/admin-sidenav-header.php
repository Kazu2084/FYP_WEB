            ...
            <ul class="nav flex-column" id="aside-nav-ul">
              ...
              <li class="nav-item">
                <a class="nav-link" href="register-student.php">
                  ...
                  <span style="font-size: 18px;" class="ms-2">Add Student</span>
                </a>
              </li>
             
              <li class="nav-item">
                <a class="nav-link" href="bookings.php">
                  <i class="fas fa-h-square" style="font-size: 15px;"></i>
                  <span style="font-size: 18px;" class="ms-2">Book Room</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="manage-students.php">
                  <i class="fas fa-users" style="font-size: 17px;"></i>
                  <span style="font-size: 18px;" class="ms-2">Hostel Students</span>
                </a>
              </li>
              <li class="nav-item">
