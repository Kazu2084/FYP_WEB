            ...
            <ul class="nav flex-column" id="aside-nav-ul">
              ...
              <li class="nav-item aside-dropdown">
                ...
                <ul class="collapse list-unstyled aside-dropdown-menu" id="collapsePricing">
                  <li><a style="font-size: 16px;" class="nav-link" href="pages/attemptedExams.php">Attempted</a></li>
                  <li><a style="font-size: 16px;" class="nav-link" href="pages/notAttemptedExams.php">All Exams</a></li>
                </ul>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="feedback.php" class="ms-2" style="font-size: 18px;"
                  data-toggle="modal" data-target="#feedbacksModal">
                  <i class="far fa-comment-alt" style="font-size: 19px;"></i>
                  <span style="font-size: 18px;" class="ms-2">Feedback</span>
                  <!-- <li>
                    <a href="#" class="ms-2"style="font-size: 18px;" data-toggle="modal" data-target="#feedbacksModal" >
                        Add Feedback                       
                    </a>
                </li> -->
